...
if __name__ == '__main__':
    ...
    url = 'http://www.pbc.gov.cn/tiaofasi/144941/144951/index.html'

    charset, cookie, html_url, response, UA, IP = FirefoxGetResponse().work(url)
    print(charset, cookie, html_url, response, UA, IP)
